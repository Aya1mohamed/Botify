  ...
  return (
    <div className="px-6">
      ...
      <div className="space-y-4">
        <div className="bg-white dark:bg-zinc-900 p-4 rounded shadow-sm flex flex-col justify-between sm:flex-row gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            ...
            <a
              href="#"
              className="flex items-center justify-center bg-black text-white px-4 py-2 rounded-lg shadow-md hover:opacity-90 transition gap-3"
            >
        ...
        <div className="bg-white dark:bg-zinc-900 p-4 rounded shadow-sm flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <button className="w-full sm:w-auto bg-brand-primary text-white px-3 py-1 rounded hover:bg-brand-secondary">Get Now</button>
        </div>
